...
#$ -o /igm/home/hxy008/PTZ_ATAC_scRNA_072024/WIP/Logs_bash/0624_run_1.log           # Save combined stdout/stderr to this log file


# Load the R module (adjust for your environment)
module purge
module load R-4.3.3 ## change this to curret R version
Rscript /igm/home/hxy008/PTZ_ATAC_scRNA_072024/WIP/bash2.R ## change the R script path of yours
